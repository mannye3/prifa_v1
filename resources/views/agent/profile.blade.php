                ...
                <div class="col-xl-7">
                    <div class="profile-box position-relative d-md-flex align-items-end mb50">
                        <div class="profile-img position-relative overflow-hidden bdrs12 mb20-sm">
                            ...
                            <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="" data-bs-original-title="Delete Image" aria-label="Delete Item"><span
                                    class="fas fa-trash-can"></span></a>
                        </div>
                        <div class="profile-content ml30 ml0-sm">
                            <a href="#" class="ud-btn btn-white2 mb30">Upload Profile Files<i
                ...
                <div class="col-lg-12">
                    <form class="form-style1">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="text-end">
                                    <a class="ud-btn btn-dark" href="page-contact.html">Update Profile<i
                                            class="fal fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                ...
                <form class="form-style1">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="text-end">
                                <a class="ud-btn btn-dark" href="page-contact.html">Update Social<i
                                        class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                ...
                <form class="form-style1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="text-end">
                                <a class="ud-btn btn-dark" href="page-contact.html">Change Password<i
                                        class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
