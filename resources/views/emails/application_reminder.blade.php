                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">This is to inform you that your registration on the FMDQ Depository Participant Onboarding Portal is incomplete. </p>

                                   
                                    <p style="margin-bottom: 10px;"> Kindly click on the link below to continue your registration.
                                    <br>  <a href="{{ url('login') }}">Continue Your Registration</a></p>

                                  <P>Thank you for choosing FMDQ Depository Limited.</P>
                                </td>
                            </tr>
