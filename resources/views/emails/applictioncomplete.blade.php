                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Following your application to become a Participant of FMDQ Depository, your account has been successfully created. Please see details of your account below:</p>

                                    {{-- <p style="margin-bottom: 10px;">Please see details below:</p> --}}

            
                                    <p style="color: black;"><b> Partner Name – {{$institution}} </b></p>
                                    
                                     <p style="color: black;"><b> Partner BPID – {{$Partner_BPID}} </b></p>

                                      <p style="color: black;"><b> Client BPID – {{$Client_BPID}} </b></p>
                                      <br>

                                      <p style="margin-bottom: 10px;">Kindly contact dod@fmdqgroup.com and/or dsd@fmdqgroup.com if you require any clarification and/or assistance.</p>

                                      <p style="margin-bottom: 10px;"> We welcome you to FMDQ Depository and look forward to a continued mutually beneficial relationship!</p>
