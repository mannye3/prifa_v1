                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Please be informed that {{$institution}}  has been successfully onboarded as a participant of FMDQ Depository.</p>

                                    <p style="margin-bottom: 10px;">Kindly see participant details below for your information:</p>
