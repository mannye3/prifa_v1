                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Dear ICG,</p>
                                    <p style="margin-bottom: 10px;">Please be advised that DSD/MEG/DOD have approved {{$institution}}’s  application for your information.</p>
                                    <p style="margin-bottom: 10px;">Kindly click <a href="{{ url('login') }}">here</a> to view details..</p>


                                    {{-- <p style="margin-bottom: 10px;">Kindly see participant details below:</p>
                                    ...
                                    <p style="margin-bottom: 10px;">Kindly <a href="{{ url('login') }}">login</a> to view details</p> --}}
