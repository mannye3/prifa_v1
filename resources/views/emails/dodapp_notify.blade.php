                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Dear {{$institu}},</p>
                                    <p style="margin-bottom: 10px;">Following your application to become a participant of FMDQ Depository, your account has been Rejected.  </p>
