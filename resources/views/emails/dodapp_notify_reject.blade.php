                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Dear MEG,</p>
                                    <p style="margin-bottom: 10px;">Please note that the account opening request for {{$institution}} has been rejected.</p>
                                   ...
                                   <b>Reasons:</b> 
                                    ...
                                    {!! $note !!}
                                    <br>
                                    <p style="margin-bottom: 10px;"> Kindly click on the link below to view application.
                                    <br>  <a href="{{ url('login') }}">View Application</a></p>
