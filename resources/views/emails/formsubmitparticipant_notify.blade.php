                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">We acknowledge receipt of your request and will provide feedback within three (3) working days.</p>

                                    <p style="margin-bottom: 10px;">Kindly click <a href="{{route('login')}}">here</a> to view your application.</p>
