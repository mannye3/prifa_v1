                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Dear {{$institution}},</p>
                                    <p style="margin-bottom: 10px;">Kindly find attached the Annual Eligibility Fee invoice for the payment of your application fee.</p>
                                    <p style="margin-bottom: 10px;">Kindly click <a href="{{ url('login') }}">here</a> to upload the payment receipt once payment has been concluded.</p>

                            

                                    <br>
                                    <p style="margin-bottom: 10px;">Thank you for your valued patronage.</p>
                                  
                                   
                                    {{-- <a href="{{route('userform_one_view', $app_id)}}" style="background-color:#ad8e4f;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">View Application</a> --}}
                                </td>
                            </tr>
