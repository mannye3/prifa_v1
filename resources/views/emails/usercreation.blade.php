                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Your account has been successfully created on NASD Issuers Portal.</p>
                                    <p style="margin-bottom: 10px;">Please find below details for your account.</p>


                                    <p style="color: black;"><b>LINK : <a href="https://issuers.nasdotcng.com">https://issuers.nasdotcng.com</a> </b></p>

                                     <p style="color: black;"><b> Email :   {{ $email }} </b></p>

                                      <p style="color: black;"><b> PASSWORD :  {{ $password }} </b></p>

                                       <p style="color: black;"><b> DATE CREATED :  {{ $created_at }}</b></p>
                                </td>
                            </tr>
